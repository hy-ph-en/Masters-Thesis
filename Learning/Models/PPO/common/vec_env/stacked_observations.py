...
from Learning.Models.PPO.common.preprocessing import is_image_space, is_image_space_channels_first
...
class StackedObservations(Generic[TObs]):
    ...
    ``Learning.Models.PPO.common.preprocessing.is_image_space_channels_first`` if observation is an image space.
